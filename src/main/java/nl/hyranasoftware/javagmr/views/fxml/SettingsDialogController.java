...
public class SettingsDialogController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cbStartMinimized.selectedProperty().set(JGMRConfig.getInstance().isStartMinimized());
    ...
    private void saveConfig() {
        ...
        JGMRConfig.getInstance().setStartMinimized(cbStartMinimized.selectedProperty().get());
